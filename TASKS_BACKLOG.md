...
- CC-023でlintのCI組み込み提案を確定した。workflow実装はgate ①の採用判断後に別タスク化する。
...
| CC-023 | lintのCI組み込み提案書の起草 | 2026-07-11 Claude→Codex引き継ぎ | 低 | S | done: `docs/lint-ci-integration-proposal.md`。変更範囲、`npm ci`、npm cache、`check:all`、検証、rollbackを確定。workflow実装はgate ①の採用判断後 |
